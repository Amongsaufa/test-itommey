...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    mod(require("<?php echo base_url('src')?>/lib/codemirror"), require("<?php echo base_url('src')?>/addon/mode/simple"));
  else if (typeof define == "function" && define.amd) // AMD
    define(["<?php echo base_url('src')?>/lib/codemirror", "<?php echo base_url('src')?>/addon/mode/simple"], mod);
