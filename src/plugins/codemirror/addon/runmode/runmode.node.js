...
require.cache[require.resolve("<?php echo base_url('src')?>/lib/codemirror")] = require.cache[require.resolve("./runmode.node")];
require.cache[require.resolve("<?php echo base_url('src')?>/addon/runmode/runmode")] = require.cache[require.resolve("./runmode.node")];
...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    { mod(require("<?php echo base_url('src')?>/lib/codemirror")); }
  else if (typeof define == "function" && define.amd) // AMD
    { define(["<?php echo base_url('src')?>/lib/codemirror"], mod); }
