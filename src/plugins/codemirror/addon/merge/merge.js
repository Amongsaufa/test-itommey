...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    mod(require("<?php echo base_url('src')?>/lib/codemirror")); // Note non-packaged dependency diff_match_patch
  else if (typeof define == "function" && define.amd) // AMD
    define(["<?php echo base_url('src')?>/lib/codemirror", "diff_match_patch"], mod);
